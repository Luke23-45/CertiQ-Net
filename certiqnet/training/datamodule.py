...
from certiqnet.training.supervision import heuristic_actions
...
class CertiQNetDataModule(pl.LightningDataModule if pl is not None else object):
    """Data module with synthetic, teacher, policy, and adversarial coverage."""
    ...
    def __init__(
        ...
        self.adapter = adapter if adapter is not None else QueueingAdapter(assumptions_satisfied=True)
