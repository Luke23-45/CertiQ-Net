"""Learned per-resource cost function."""
...
class CostLearner(nn.Module):
    ...
    This utility is retained for compatibility with older experiments. When
    used, gradients flow from the certificate-aware loss back through the
    predicted cost into the CostLearner's parameters, allowing it to adapt to
