...
This document replaces the z1 queue-only perspective with the z2 research
direction: CertiQ-Net is not merely a better queue-routing rule. It is a
...
This document treats that statement as the backbone proof obligation unless it
has already been proved in a separate theorem file.
...
identity, and standard irreducibility/non-explosion conditions for countable
state CTMCs with bounded total transition rate growth.
